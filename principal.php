...
<html lang="pt-br">
  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark barra">
      <a class="navbar-brand" href="#">Oxbar </a>
      <button
          ...
          <ul class="menu">
            <li>
              <a href="./principal.html" class="menu-item"
                ><i class="fa-solid fa-user"></i> Usuario</a
              >
            </li>
            <li>
              <a href="./cidade.html" class="menu-item"
                ><i class="fa-solid fa-city"></i> cidade</a
              >
            </li>
            <li>
            ...
            <li>
              <a href="./funcionario.html" class="menu-item"
                ><i class="fa-solid fa-user-tie"></i> funcionario</a
              >
            </li>
            <li>
              <a href="./produto.html" class="menu-item"
                ><i class="fa-solid fa-dolly"></i> produto</a
              >
            </li>
            <li>
              <a href="./venda.html" class="menu-item"
                ><i class="fa-solid fa-cart-shopping"></i> venda</a
              >
            </li>
          </ul>
        </div>
